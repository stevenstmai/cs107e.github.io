...
associated with a given PS/2 device. The struct defined in the starter code has
...
To submit the extension for grading, tag with `assign5-extension`. In your `README.md` for assign5, list the editing features and shell commands supported by your fancy extended shell so we'll know how to try it out when grading.
